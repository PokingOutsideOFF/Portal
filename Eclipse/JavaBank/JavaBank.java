...
public class JavaBank extends JFrame {
    ...
    private void createUserInterface() {
        ...
        contentPane.setBackground(myColor);//new insertion
        ...
        inputDetailJPanel.setBackground(myColor);//new insertion
    ...
    private void CreateAccountJButtonActionPerformed(ActionEvent event) {
        ...
        //int emptyAccount = 11;
        	...
        	if ((noAccounts <= 9) & (Name != "") & (Accountnum != 0))  {        		
       		 ...
       		 displayAccountDetails(myAccounts[noAccounts].getBankName(),myAccounts[noAccounts].getaccountname(),myAccounts[noAccounts].getaccountnum(),myAccounts[noAccounts].getbalance());
        		noAccounts ++;
    ...
    private void DisplayJButtonActionPerformed(ActionEvent event) {
    	...
    	for (int i=0; i<noAccounts; i++) { 
    		...
    		// displayAccountDetails(myAccounts[i].getBankName(),myAccounts[i].getaccountname(),myAccounts[i].getaccountnum(),myAccounts[i].getbalance());
